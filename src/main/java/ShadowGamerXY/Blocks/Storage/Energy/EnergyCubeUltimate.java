...
public class EnergyCubeUltimate extends Block implements IWrenchabe
{
		public IIcon output;
		public IIcon base;
		...
		public EnergyCubeUltimate()
		{
			...
			this.setBlockName("EnergyCubeUltimate");
		...
		public TileEntity createTileEntity(World world, int meta) 
		{
			...
			{
			case 0:
				return new TileEntiyEnergyCubeMk3();
			}
				return null;
		}
		...
		public IIcon getIcon(IBlockAccess world,int x,int y,int z, int side)
		{
			...
			{
			case 0:
				TileEntiyEnergyCubeMk3 te = (TileEntiyEnergyCubeMk3) world.getTileEntity(x, y, z);
