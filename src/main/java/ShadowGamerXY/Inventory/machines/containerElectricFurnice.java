...
public class containerElectricFurnice extends Container
{
	...
	public final int y;
	public final int z;
	private TileEntiyElectricFurnice tile;
	
	public static final int INPUT = 0, OUTPUT = 1;
	
	public containerElectricFurnice(EntityPlayer player, World world, int x, int y, int z) 
	{
		this.player = player;
		this.world = world;
		this.x = x;
		this.y = y;
		this.z = z;
		this.tile = (TileEntiyElectricFurnice) world.getTileEntity(x, y, z);
