...
public class GuiElectricFurniceAdv extends GuiContainer
{
private static final ResourceLocation texture = new ResourceLocation(references.MOD_ID.toLowerCase() + ":textures/gui/guiElFurnice.png");
	...
	public final int y;
	public final int z;
	public static TileEntiyElectricFurniceAdvanced te;

	public GuiElectricFurniceAdv(EntityPlayer player, World world, int x,int y,int z) 
	{
		super(new containerElectricFurniceAdv(player, world, x, y, z));
		...
		this.te =(TileEntiyElectricFurniceAdvanced) world.getTileEntity(x, y, z);
	}
