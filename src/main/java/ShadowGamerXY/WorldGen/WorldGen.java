...
public class WorldGen implements IWorldGenerator {
		...
		private void generateSurface(Random random, int chunkX, int chunkZ, World world) {
			addOre(ModBlocks.NegalOre, Blocks.stone, random, world, chunkX, chunkZ, 20, 54, 3, 8, 25);
			addOre(ModBlocks.ZixiriumOre, Blocks.stone, random, world , chunkX, chunkZ, 10, 15, 4, 8, 25);
			addOre(ModBlocks.LithiumOre, Blocks.stone, random, world , chunkX, chunkZ, 20, 54, 4, 8, 25);
			addOre(ModBlocks.NickelOre, Blocks.stone, random, world , chunkX, chunkZ, 20, 54, 4, 8, 25);
