...
public class TileEntiyElectricFurniceAdvanced extends TileEntity implements IEnergy,IInventory
{
		private EnergyBar energyBar = new EnergyBar(5000);
		private ItemStack[] inventory = new ItemStack[18];
		private int energyUsePerSmelt = 350;
		private int defaultEnergyUsePerSmelt = 350;
		public boolean isSmelting;
		private int smeltStatus;
		private int smeltTime = 40;
		private int defaultSmeltTime = 40;
